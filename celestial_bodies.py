...
class CelestialBody():
    ...
    def position_update(self, CelestialBodies):
        ...
        self.x_position += (self.vel_x * TIME) / 1e25

            
        #if (self.y_position > 0 and self.y_position < HEIGHT):
        #    self.y_position += (self.vel_y * TIME) / 1e25
        #else:
        #    self.vel_y = 4.9906778e+25
...
class Planet(CelestialBody):
    def __init__(self, name, star, distance_from_star, color, mass, radius):
        ...
        self.y_position = star.y_position + math.sqrt(distance_from_star) / SCALE
